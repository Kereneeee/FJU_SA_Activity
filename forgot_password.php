...
.btn-primary-custom:disabled { opacity: 0.7; transform: none; }
...
<div class="card-box">
    ...
    <form method="POST" onsubmit="const btn=this.querySelector('button[type=submit]'); btn.disabled=true; btn.innerHTML='<i class=\'bi bi-hourglass-split me-1\'></i> 送出中…';">
        <div class="mb-3">
    ...
    <div class="text-center">
        <i class="bi bi-envelope-check-fill" style="font-size:50px; color:#1e4d6b;"></i>
        <h5 class="mt-3 mb-2">申請已送出！請至信箱收取確認信</h5>
